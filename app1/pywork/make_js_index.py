# coding=utf-8
""" make_js_index.py for boesp1 (all three volumes)
"""
...
if __name__ == "__main__":
 filevol = sys.argv[1] # I, II, or III or ALL
 filein=sys.argv[2]  # tab-delimited index file
 fileout = sys.argv[3]
 pagerecs = init_pagerecs(filein,filevol)
 # parm_numparm is global (see top of this file)
 if parm_numparm == 1:
  outrecs = make_js_1(pagerecs)  # this is the one used.
 elif parm_numparm == 2:
